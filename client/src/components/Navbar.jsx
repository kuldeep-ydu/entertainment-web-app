...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 mt-0 flex items-center justify-between bg-secondary-dark px-6 py-4 sm:top-6 sm:mx-6 sm:mt-6 sm:rounded-lg md:h-[90vh] md:flex-col md:rounded-3xl md:py-8">
