    ...
    <li>
      <article className="grid grid-cols-1 grid-rows-1 w-fit isolate">
        ...
        <div className="row-start-1 col-start-1 rounded-lg bg-black bg-opacity-50 opacity-0 hover:opacity-100 focus-within:opacity-100 transition relative">
          ...
          <button className="p-[6px] pr-5 text-md font-normal flex items-center gap-5 hover:scale-[1.1] focus-visible:scale-[1.1] bg-white bg-opacity-25 rounded-full absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-2/4">
