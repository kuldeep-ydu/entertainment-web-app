  ...
  return (
    <div className="relative mt-auto" ref={menuRef}>
      <button
        ...
        className={`aspect-square overflow-hidden rounded-full border transition ${menuHidden ? 'border-white' : 'border-accent'} hover:border-accent focus-visible:border-accent`}
      >
        <img
